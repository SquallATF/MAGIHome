...
import jp.co.evangelion.nervhome.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    private static final String LOG_TAG = "MAGI";
    ...
    static final String AUTHORITY = "jp.co.evangelion.nervhome.settings";
    
    static final String EXTRA_BIND_SOURCES = "jp.co.evangelion.nervhome.settings.bindsources";
    static final String EXTRA_BIND_TARGETS = "jp.co.evangelion.nervhome.settings.bindtargets";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int loadFavorites(SQLiteDatabase db) {
        	if (LOGD) Log.d(LOG_TAG, "loadFavorites");
