...
public class UserFolder extends Folder implements DropTarget {
    ...
    private class FolderAdapter extends ArrayAdapter<ApplicationInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.folder_application_boxed, parent,
						false);
			}
			...
			if (info.icon.getBounds().isEmpty()) {
				info.icon.setBounds(0, 0, 96, 96);
			}

			final TextView textView = (TextView) convertView;
			textView.setCompoundDrawables(null, info.icon, null,
					null);
