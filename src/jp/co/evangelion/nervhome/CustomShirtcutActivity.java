...
public class CustomShirtcutActivity extends Activity implements OnClickListener {
	public static final String ACTION_ADW_PICK_ICON="jp.co.evangelion.nervhomes.icons.ACTION_PICK_ICON";
	public static final String ACTION_LAUNCHERACTION = "jp.co.evangelion.nervhome.action.launcheraction";
